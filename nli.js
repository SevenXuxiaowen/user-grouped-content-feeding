...
var common = [
    ...
    'during', 'like', 'after', 'above', 'below', 'to', 'from',
    ...
    "wasn't", 'weren', "weren't", 'won', "some", 'want', "search"
];
/* Reference: "https://towardsdatascience.com/introduction-to-natural-language-processing-for-text-df845750fb63" */

function decide(e) {
    return e.equals("love");
}

function nli(input) {
    var tokens = input.split(" ").map(function (item) {
